...
md"Definiendo la variable simbólica w, SymEngine.jl permite substituir s=jw en la transferencia H(s) para visualizar las transferencias como diagrama de Bode."
